...
export default function TourCarousel() {
  ...
  return (
    <div className=" lg:max-w-[1200px] lg:m-auto lg:p-12 py-10 ">
      <div className="flex lg:flex-row flex-col lg:space-x-10 lg:items-center text-[#404040] pb-10 px-[20px] px-0">
        <h1 className="text-[#1E1E1E] lg:text-[50.3px] text-3xl font-[400]">{t('tour')}</h1>
        <p className="text-[16px] font-[400] lg:w-[60%]">{t('tours_invite')}</p>
      </div>
